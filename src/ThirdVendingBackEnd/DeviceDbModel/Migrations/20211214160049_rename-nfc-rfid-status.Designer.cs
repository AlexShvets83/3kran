...
namespace DeviceDbModel.Migrations
{
    ...
    [Migration("20211214160049_rename-nfc-rfid-status")]
    partial class renamenfcrfidstatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeviceDbModel.Models.AppSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<long>("FileMaxUploadLenght")
                        .HasColumnType("bigint")
                        .HasColumnName("file_max_upload_lenght");

                    b.Property<bool>("SupportBoard1")
                        .HasColumnType("boolean")
                        .HasColumnName("support_board1");

                    b.Property<bool>("SupportBoard2")
                        .HasColumnType("boolean")
                        .HasColumnName("support_board2");

                    b.Property<bool>("SupportBoard3")
                        .HasColumnType("boolean")
                        .HasColumnName("support_board3");

                    b.Property<int>("UserLogDepth")
                        .HasColumnType("integer")
                        .HasColumnName("user_log_depth");

                    b.Property<int>("UsersMaxDownloads")
                        .HasColumnType("integer")
                        .HasColumnName("users_max_downloads");
            ...
            modelBuilder.Entity("DeviceDbModel.Models.DevEncash", b =>
                {
                    ...
                    b.Property<float?>("CoinsChange")
                        .HasColumnType("real")
                        .HasColumnName("coins_change");
                    ...
                    b.Property<float?>("RfidCard")
                        .HasColumnType("real")
                        .HasColumnName("rfid_card");
            ...
            modelBuilder.Entity("DeviceDbModel.Models.FileModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Visible")
                        .HasDatabaseName("ix_files_visible");
            ...
            modelBuilder.Entity("DeviceDbModel.Models.LogUsr", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("LogDate")
                        .HasDatabaseName("ix_user_log_log_date");
